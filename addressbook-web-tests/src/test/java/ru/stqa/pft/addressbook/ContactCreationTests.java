...
public class ContactCreationTests {
  ...
  public void testContactCreationTests() throws Exception {
    addNewContact(new ContactData("Name", "MiddleName",
  ...
  private void addNewContact(ContactData contactData) {
    ...
    wd.findElement(By.name("byear")).sendKeys(contactData.getYear_of_birth());
    ...
    wd.findElement(By.name("phone2")).sendKeys(contactData.getHomenumber());
